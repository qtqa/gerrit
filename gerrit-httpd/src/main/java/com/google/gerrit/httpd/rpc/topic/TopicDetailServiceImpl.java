...
class TopicDetailServiceImpl implements TopicDetailService {
  private final AddTopicReviewer.Factory addTopicReviewerFactory;
  ...
  private final RemoveTopicReviewer.Factory removeTopicReviewerFactory;
  ...
  @Inject
  TopicDetailServiceImpl(final AddTopicReviewer.Factory addTopicReviewerFactory,
      ...
      final RemoveTopicReviewer.Factory removeTopicReviewerFactory,
  ...
  public void addTopicReviewers(final Topic.Id id, final List<String> reviewers,
    ...
    addTopicReviewerFactory.create(id, reviewers).to(callback);
  }
